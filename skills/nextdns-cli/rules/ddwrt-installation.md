...
impact: HIGH
impactDescription:
  'Without proper JFFS setup and installation procedures, NextDNS CLI will fail to persist on DD-WRT
  routers, causing DNS configuration loss after reboots and potential certificate errors due to time
  sync issues.'
type: capability
tags:
  - DD-WRT
