...
If your network uses standard DNS servers (e.g., `45.90.28.16`), NextDNS needs to know your public
IP to apply your custom settings.

- **Link IP**: Click the "Link IP" button in the Setup tab of the dashboard.
- **Dynamic IPs**: If your ISP changes your IP frequently (e.g., when the modem restarts), the link
