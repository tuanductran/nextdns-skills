...
1. [Capability rules](#1-capability-rules) — **MEDIUM**
   ...
   - 1.16 [Select a NextDNS transport and setup method](#116-select-a-nextdns-transport-and-setup-method)
   - 1.17 [Synology Integration (DSM and SRM)](#117-synology-integration-dsm-and-srm)
   - 1.18 [Tailscale Integration](#118-tailscale-integration)
   - 1.19 [Ubiquiti (UniFi) Integration](#119-ubiquiti-unifi-integration)
...
### 1.16 Select a NextDNS transport and setup method

**Impact: HIGH (Selecting an incompatible transport or omitting the required profile association can leave DNS traffic unfiltered, unencrypted, or attributed to the wrong profile.)**
...
**Correct: Configure native encrypted DNS when the platform supports it**
...
**Correct: Use Linked IP only for legacy UDP/IPv4**
