...
impact: HIGH
impactDescription:
  'Proper installation and configuration of NextDNS on OpenWrt routers ensures network-wide DNS
  protection. Without this guidance, users may struggle with installation methods, upgrades, or
  troubleshooting issues specific to OpenWrt environments.'
type: capability
tags:
  - openwrt
  - router
